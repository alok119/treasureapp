...
<form method="POST">
    ...
    ?>
    <?php generate_token(); ?>
    <?php if (isset($_SESSION['token_generated']) AND $_SESSION['token_generated'] === true AND $_SESSION['token_btn'] === 'hide') : ?>
        <p class="info">
        ...
        <div class="input-holder">
            <input
                    class="token-input" placeholder="Five Digit Token"
                    type="text" name="user-token" autocomplete="off"
            />
