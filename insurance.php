...
if ($_SERVER['REQUEST_METHOD'] === 'POST')
{
    ...
    if(!empty($GeneratedReceiptNumber))
    {
        ...
        if(empty($_POST['transact_date'])){
            $data_for_bal_table['DirectTransactionDate'] =  $dat_to_store['DirectTransactionDate'] = '0000-00-00 00:00:00';
        }
        else{
...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header">Post Premium Recieved Insurance</h2>
        </div>
...
<script src="supervisor/assets/js/jquery1.11.1.min.js"></script>
<script src="supervisor/assets/js/jquery.min.js"></script>
<script src="supervisor/assets/js/moment.min.js"></script>
<script src="supervisor/assets/js/daterangepicker.js"></script>
<script src="supervisor/assets/js/moment.min.js"></script>

<script src="supervisor/assets/js/typeahead.min.js"></script>
<script src="supervisor/assets/js/modepick.js"></script>
<script src="supervisor/assets/js/demomination.js"></script>
<script src="supervisor/assets/js/currencyvalue.js"></script>
<script src="supervisor/assets/js/sum_up_values.js"></script>
<link href="supervisor/assets/css/datepicker.min.css" rel="stylesheet" type="text/css">
<script src="supervisor/assets/js/datepicker.min.js"></script>
<script src="supervisor/assets/js/member_split.js"></script>
<script src="supervisor/assets/js/fill_up_fields.js"></script>
<style>
    input.datepicker-here {width: 100%;}
</style>

<script src="supervisor/assets/js/i18n/datepicker.en.js"></script>
<link rel="stylesheet" href="supervisor/assets/css/typeahead.css">
<link rel="stylesheet" type="text/css" href="supervisor/assets/css/daterangepicker.css">
<script>
